      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-5">
        ...
        <div>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <SocialIcon href={SITE_CONTACT.facebook} label="Facebook" className="bg-[#1877f2]">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
            ...
            <SocialIcon href={SITE_CONTACT.instagram} label="Instagram" className="bg-[#e1306c]">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
            ...
            <SocialIcon href={SITE_CONTACT.tiktok} label="TikTok" className="bg-[#111827]">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
